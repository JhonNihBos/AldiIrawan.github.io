...
<div class="box box-success">
	...
	<form class="form-horizontal" action="<?php echo site_url('kriteria/ubah/' . $id_kriteria); ?>" method="post" id="ubah-form">
		...
		<div class="box-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input name="bobot" id="bobot" required type="number" class="form-control" value="<?php echo set_value('bobot', $bobot); ?>" step="any" onchange="cekBobot()">
					<p style="font-size: 11px; color: red; display: none;" id="bobot-detail">maksimal bobot = 1 dan harus decimal</p>
				</div>
			</div>
			<div class="form-group">
...
<script>
	document.getElementById('ubah-form').onsubmit = function() {
		let v = document.getElementById('bobot').value;
		if (!(v > 0 && v <= 1)) {
			document.getElementById('bobot-detail').style.display = 'block'
			return false;
		} else {
			document.getElementById('bobot-detail').style.display = 'none'
		}
	};
