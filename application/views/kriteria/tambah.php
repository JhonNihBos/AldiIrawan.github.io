...
<div class="box box-success">
	...
	<form class="form-horizontal" action="<?php echo site_url('kriteria/tambah'); ?>" method="post" id="tambah-form">
		<div class="box-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input name="bobot" id="bobot" required type="number" class="form-control" value="<?php echo set_value('bobot'); ?>" onchange="cekBobot()" step="any">
					<p style="font-size: 11px; color: red;" id="bobot-detail">maksimal bobot = 1 dan harus decimal</p>
				</div>
			</div>
			<div class="form-group">
...
<script>
	document.getElementById('tambah-form').onsubmit = function() {
